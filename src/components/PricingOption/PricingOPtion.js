...
const PricingOPtion = (props) => {
    ...
    return (
        <div className='bg-white p-4 rounded-lg'>
            ...
            <div>
                <h3 className='text-xl text-left'>Benefist:  </h3>
             {
                 benefits.map(benefit => <Benefit benefit={benefit}></Benefit>)
             }
                
            </div>
            <button className='bg-green-500 flex justify-center w-full py-2 rounded mt-6 text-white hover:text-gray-700 font-bold'>
